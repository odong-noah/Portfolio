...
const SOCIAL_LINKS = [
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/odong-noah',
    icon: (
    ...
    <footer className={styles.footer} role="contentinfo">
      <div className={styles.top}>
        ...
        <div className={styles.contactCol}>
          ...
          <a href="/resume.pdf" download="Odong_Noah_Resume.pdf" className={styles.resumeBtn}>
      ...
      <div className={styles.bottom}>
        <p>© {new Date().getFullYear()} Odong Noah. For modern computer Software, AI Business Solutions and Professional IT Support.</p>
        <p className={styles.built}>Built with Next.js &amp; CSS Modules</p>
      </div>
    </footer>
  );
}
